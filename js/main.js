...
window.API_BASE_URL = window.location.protocol === 'file:' ? 'http://localhost/GHT/backend/' : 'backend/';

document.addEventListener('DOMContentLoaded', () => {
    // 0. Login Wall
    const isLoggedIn = localStorage.getItem('isLoggedIn') === 'true';
    const publicPages = ['login.html', 'register.html', 'forgot-password.html', 'admin-login.html'];
